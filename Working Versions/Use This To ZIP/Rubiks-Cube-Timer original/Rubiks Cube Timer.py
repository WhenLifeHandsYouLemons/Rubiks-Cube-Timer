...
with open(get_true_filename("C:/Rubiks-Cube-Timer/Sessions/Session1.txt"), "r") as f:
    content = f.read()
...
with open(get_true_filename("C:/Rubiks-Cube-Timer/Averages/ao5.txt"), "r") as f:
    content = f.read()
    lines = content.splitlines()
    for line in lines:
        line = float(line)
...
with open(get_true_filename("C:/Rubiks-Cube-Timer/Averages/ao12.txt"), "r") as f:
    content = f.read()
    lines = content.splitlines()
    for line in lines:
        line = float(line)
...
statistic_display_font = get_true_filename("C:/Rubiks-Cube-Timer/Fonts/arialbd.ttf")
...
timer_display_font = get_true_filename("C:/Rubiks-Cube-Timer/Fonts/arial.ttf")
...
title_size = 80
title_display_font = get_true_filename("C:/Rubiks-Cube-Timer/Fonts/joystix.ttf")
...
add_to_file = "\n".join(all_ao5_str)
with open("C:/Rubiks-Cube-Timer/Averages/ao5.txt", "w") as f:
    f.write(add_to_file)
...
add_to_file = "\n".join(all_ao12_str)
with open("C:/Rubiks-Cube-Timer/Averages/ao12.txt", "w") as f:
    f.write(add_to_file)
