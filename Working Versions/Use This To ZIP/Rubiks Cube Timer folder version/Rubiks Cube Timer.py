...
try:
    with open("C:/Rubik's Cube Timer/Sessions/Session1.txt", "r") as f:
        content = f.read()
    ...
    os.makedirs("/Rubik's Cube Timer/Sessions")
...
try:
    ...
    os.mkdir("/Rubik's Cube Timer/Averages")
...
def timer_function():
    while start_timer_check[0] == 1:
        ...
        if keys[pygame.K_SPACE]:
            ...
            add_to_file = "\n".join(all_times)
            with open("C:/Rubik's Cube Timer/Sessions/Session1.txt", "w") as f:
                    f.write(add_to_file)
